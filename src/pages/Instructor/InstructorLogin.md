...
<br />
  ...
  ![alt text](/images/InstructorLogin.png "Title")

<br />


* Click on **Login** button on the navbar to direct you to instructor's login form
<br />

  ![alt text](/images/InstructorLoginForm.png "Title")
